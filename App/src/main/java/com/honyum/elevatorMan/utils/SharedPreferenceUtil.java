...
public class SharedPreferenceUtil {
    ...
    public static void save(String fileKey, String key, Object saveObject) {
        SharedPreferences sharedPreferences = MyApplication.getInstance().getSharedPreferences(fileKey, Activity.MODE_PRIVATE);
    ...
    public static void cleanShardFile(String fileKey) {
        SharedPreferences sharedPreferences =  MyApplication.getInstance().getSharedPreferences(fileKey, Activity.MODE_PRIVATE);
