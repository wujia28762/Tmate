...
import kotlinx.android.synthetic.main.activity_repair_rescue_code.*
...
class RepairRescueCodeActivity : BaseActivityWraper(), ListItemCallback<File> {
    override fun performItemCallback(data: File?) {
        screen_image1.visibility = View.VISIBLE
        Glide.with(this)
                .load(data)
                .priority(Priority.HIGH)
                .into(screen_image1)
        screen_image1.onClick {
    ...
    override fun getLayoutID(): Int {
        return R.layout.activity_repair_rescue_code
    }
    ...
    private fun requestElevator(number: String) {
