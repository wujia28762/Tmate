...
public class ElevatorInfo1 implements Serializable{
    ...
    public void setDoorwayPicture(String doorwayPicture) {
        this.doorwayPicture = doorwayPicture;
    }

    public String getDragModeName() {
        return dragModeName;
    }

    public void setDragModeName(String dragModeName) {
        this.dragModeName = dragModeName;
    }
