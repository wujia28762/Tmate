...
public class SlidingDrawer extends ViewGroup {
    ...
    public static interface OnDrawerScrollListener {
         ...
         *
         * @param willBackward true if the user reverse dragging/flinging
         */
...
//					heightSpecSize, MeasureSpec.EXACTLY));
     ...
     * @param velocity     initialized velocity
     * @param autoAnimated {@link #animateOpen()} and {@link #animateClose()}
     */
