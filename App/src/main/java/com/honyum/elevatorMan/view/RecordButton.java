...
//                dialogImg.setImageResource(R.drawable.record_animate_01);
    ...
    private void setDialogImage() {
        if (voiceValue < 3000.0) {
            dialogImg.setImageResource(R.drawable.chat_icon_voice1);
        } else if (voiceValue > 3000.0 && voiceValue < 4000.0) {
            dialogImg.setImageResource(R.drawable.chat_icon_voice2);
        } else if (voiceValue > 4000.0 && voiceValue < 5000.0) {
            dialogImg.setImageResource(R.drawable.chat_icon_voice3);
        } else if (voiceValue > 5000.0 && voiceValue < 6000.0) {
            dialogImg.setImageResource(R.drawable.chat_icon_voice4);
        } else if (voiceValue > 6000.0 && voiceValue < 7000.0) {
            dialogImg.setImageResource(R.drawable.chat_icon_voice5);
        } else if (voiceValue > 7000.0 && voiceValue < 8000.0) {
            dialogImg.setImageResource(R.drawable.chat_icon_voice6);
            ...
            while (recordState == RECORD_ON) {
                {
                    try {
                        ...
                        Log.d("AAA", "AudioRecodeTime ===>> " + recodeTime);
                        Log.d("AAA", "AudioRecodeTime (int) ===>> " + (int) recodeTime);

                        //达到最高录制时长
                        if ((int) recodeTime == MAX_RECORD_TIME) {
                            ...
                            recordHandler.sendEmptyMessage(101);
                        }
