...
public class CompanyMentenanceListAdapter extends BaseListViewAdapter<MaintRecInfo> {
    public CompanyMentenanceListAdapter(List datas, Context context) {
    ...
    public void bindData(BaseViewHolder holder, final MaintRecInfo o, int index) {
        ...
        holder.setVisible(R.id.img_detail,false).setText(R.id.tv_taskcode,o.getMaintType()).setText(R.id.tv_person,"时间："+o.getPlanTime()).setVisible(R.id.tv_state,false).setText(R.id.tv_index,index+1+"")
